    ...
    <div class="container-fluid position-relative p-0">
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-0">
            <a href="" class="navbar-brand p-0">
                <h1 style="color:  #2C3E50"><i class="fa fa-map-marker-alt me-3"></i>Destination Malawi</h1>
                <h5 style="color: #2C3E50; margin-left:0%;">Log in to make a booking</h5>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                ...
                <a href="login.php" style="background-color: rgba(3, 3, 3, 1);" class="btn btn-primary rounded-pill py-2 px-4">LOG IN</a>
            </div>
        </nav>
    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5">Get In Touch For Any Inquirery</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>Write Us</h5>
                    <p class="mb-4">If you have anything to talk to us dont hesitate to get in contact through our various channels</p>
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">Majiga 1, Balaka, Malawi</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-4">
                        <div class="d-flex align-items-center justify-content-center flex-shrink-0 bg-primary" style="width: 50px; height: 50px;">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">+265 881 100 00 82</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-3">
                            ...
                            <p class="mb-0">mziyaemmanuel@gmail.com</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-12 wow fadeInDown" data-wow-delay="0.5s">
                    <form action="mailto:mziyaemmanuel@gmail.com" method="post" enctype="text/plain">
                        <div class="row g-3" type="input">
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <div class="form-floating">
                                    <textarea class="form-control" placeholder="Leave a message here" id="message" style="height: 100px" type="submit" ></textarea>
